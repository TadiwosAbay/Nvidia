...
//__global__ void wmma_ker(input_t *A, input_t *B, output_t *C, bool init = false) {
...
template <typename output_t>
__global__ void wmma_ker(binary32_t *A, binary32_t *B, output_t *C, bool init) {
    ...
    wmma::fragment<wmma::accumulator, 16, 16, 8, output_t> C_fragment;
...
template <typename output_t>
__global__ void wmma_ker(binary64_t *A, binary64_t *B, output_t *C, bool init) {
    ...
    wmma::fragment<wmma::accumulator, 8, 8, 4, output_t> C_fragment;
